    ...
    <div className='w-full h-screen flex flex-col justify-center items-center bg-white'> 
        ...
        <div className='font-heading font-bold md:text-4xl flex mb-10'>
            ...
            <motion.div 
                ...
                whileTap={{scale:0.95}}
                className='bg-gradient-to-br from-red-500 via-pink-600 to-cyan-500 p-0.5 rounded-xl w-min'
                >
                <motion.button 
                    whileHover={{scale:1}}
        ...
        <motion.div
            ...
            className='fixed -top-48 -left-48 w-96 h-96 md:-top-[300px] md:-left-[300px] md:w-[600px] z-0 md:h-[600px] bg-gradient-to-br from-red-600 via-pink-600 to-orange-600 rounded-full'
        >
        </motion.div>
        ...
        <motion.div
            ...
            className='fixed -bottom-48 -right-48 w-96 h-96 md:-bottom-[450px] z-0 md:-right-[450px] md:w-[900px] md:h-[900px] bg-gradient-to-br from-cyan-400 via-blue-600 to-orange-600 rounded-full'
        >
        </motion.div>  
